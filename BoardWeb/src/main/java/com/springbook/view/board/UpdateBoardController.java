...
public class UpdateBoardController {
	...
	public String updateBoard(BoardVO vo, BoardDAO boardDAO) {
		...
		/*
		 * //1. 사용자 입력 정보 추출 //request.setCharacterEncoding("EUC-KR"); String
		 ...
		 * vo.setContent(content); vo.setSeq(Integer.parseInt(seq)); BoardDAO boardDAO
		 * =new BoardDAO(); boardDAO.updateBoard(vo);
		 * 
		 * //3. 화면 네비게이션 //return"getBoardList.do";
		 * 
